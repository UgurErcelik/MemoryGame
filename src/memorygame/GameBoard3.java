...
public class GameBoard3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        timer4_label = new javax.swing.JLabel();
        ...
        setTitle("6x5 Memory Game");
        setMinimumSize(new java.awt.Dimension(710, 870));
        setResizable(false);
        setSize(new java.awt.Dimension(710, 870));
        ...
        ScoreScreenLabel.setBounds(35, 36, 63, 41);
        ...
        ScoreScreen.setBounds(103, 33, 181, 41);
        ...
        startGameButton.setBounds(317, 28, 119, 50);
        ...
        QuitButton.setBounds(443, 28, 119, 50);
        ...
        Tile11.setBounds(35, 117, 100, 100);
        ...
        Tile12.setBounds(142, 117, 100, 100);
        ...
        Tile13.setBounds(249, 117, 100, 100);
        ...
        Tile14.setBounds(356, 117, 100, 100);
        ...
        Tile15.setBounds(463, 117, 100, 100);
        ...
        Tile21.setBounds(35, 224, 100, 100);
        ...
        Tile22.setBounds(142, 224, 100, 100);
        ...
        Tile23.setBounds(249, 224, 100, 100);
        ...
        Tile24.setBounds(356, 224, 100, 100);
        ...
        Tile25.setBounds(463, 224, 100, 100);
        ...
        Tile31.setBounds(35, 331, 100, 100);
        ...
        Tile32.setBounds(142, 331, 100, 100);
        ...
        Tile33.setBounds(249, 331, 100, 100);
        ...
        Tile34.setBounds(356, 331, 100, 100);
        ...
        Tile35.setBounds(463, 331, 100, 100);
        ...
        Tile41.setBounds(35, 438, 100, 100);
        ...
        Tile42.setBounds(142, 438, 100, 100);
        ...
        Tile43.setBounds(249, 438, 100, 100);
        ...
        Tile44.setBounds(356, 438, 100, 100);
        ...
        Tile45.setBounds(463, 438, 100, 100);
        ...
        Tile51.setBounds(35, 545, 100, 100);
        ...
        Tile52.setBounds(142, 545, 100, 100);
        ...
        Tile53.setBounds(249, 545, 100, 100);
        ...
        Tile54.setBounds(356, 545, 100, 100);
        ...
        Tile61.setBounds(35, 652, 100, 100);
        ...
        Tile62.setBounds(142, 652, 100, 100);
        ...
        Tile63.setBounds(249, 652, 100, 100);
        ...
        Tile64.setBounds(356, 652, 100, 100);
        ...
        getContentPane().add(Tile65);
        Tile65.setBounds(463, 652, 100, 100);

        timer4_label.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        timer4_label.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(timer4_label);
        timer4_label.setBounds(580, 28, 100, 74);
        ...
        menu_button.setBounds(142, 759, 77, 36);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\ugure\\OneDrive\\Belgeler\\NetBeansProjects\\MemoryGame-master\\src\\memorygame\\MGshapes\\papers.co-sm58-cool-pastel-blur-gradation-blue-30-wallpaper.jpg")); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 710, 810);
    ...
    private void startGameButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startGameButtonActionPerformed
        ...
        tileControl.initShuffle6x5Tiles();
        for (int i = 0; i<= 29; i++){
            System.out.print(i + ": ");
            int type = tileControl.get6x5TileType(i);
    ...
    private void Tile11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tile11ActionPerformed
        ...
        type = tileControl.get6x5TileType(ID);
        buttonPress(ID, type);
    ...
    private void showTileShape(int ID, int type){
        ...
        shapes.add(Projector);
        shapes.add(Violin);
        shapes.add(Trumpet);
        shapes.add(Microphone);
        shapes.add(Saxophone);
        shapes.add(Radio);
        shapes.add(Musical);
        shapes.add(Note);
        shapes.add(mKeyboard);
        shapes.add(microPhone);
        shapes.add(Slider);
        shapes.add(Guitar);
        shapes.add(Drum);
    ...
    private void checkEndGame(){
        if (    !Tile11.isEnabled() && !Tile12.isEnabled() && !Tile13.isEnabled() && !Tile14.isEnabled() && !Tile15.isEnabled() && 
                ...
                !Tile51.isEnabled() && !Tile52.isEnabled() && !Tile53.isEnabled() && !Tile54.isEnabled() && !Tile55.isEnabled() &&
                !Tile61.isEnabled() && !Tile62.isEnabled() && !Tile63.isEnabled() && !Tile64.isEnabled() && !Tile65.isEnabled() ){
    ...
    public static javax.swing.JLabel timer4_label;
    ...
    ImageIcon Projector   = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/film-projector-icon.png"));
    ImageIcon Violin  = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/violin-icon.png"));
    ImageIcon Trumpet    = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/trumpet-icon.png"));
    ImageIcon Microphone     = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/studio-microphone-icon.png"));
    ImageIcon Saxophone         = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/saxophone-icon.png"));
    ImageIcon Radio = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/radio-icon.png"));
    ImageIcon Musical = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/musical-score-icon.png"));
    ImageIcon Note   = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/musical-note-icon.png"));
    ImageIcon mKeyboard    = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/musical-keyboard-icon.png"));
    ImageIcon microPhone      = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/microphone-icon.png"));
    ImageIcon Slider      = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/level-slider-icon.png"));
    ImageIcon Guitar  = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/guitar-icon.png"));
    ImageIcon Drum         = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/drum-icon.png"));
    ImageIcon Camera       = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/camera-icon.png"));
    ImageIcon Notes      = new javax.swing.ImageIcon(getClass().getResource("/memorygame/MGshapes/musical-notes-icon.png"));
